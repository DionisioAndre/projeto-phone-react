...
const ProductManagement = () => {
    ...
    const fetchProducts = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.get('https://pagapouco.onrender.com/api/routeradmin/products/', {
                headers: {
    ...
    const handleDelete = async (productId) => {
        if (window.confirm('Tem certeza que deseja apagar este produto?')) {
            try {
                await axios.delete(`https://pagapouco.onrender.com/api/routeradmin/products/${productId}/`, {
                    headers: {
                        Authorization: `Bearer ${user.token}`
                    }
                });
